...
func (m *MockIRedisCache) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockIRedisCacheMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockIRedisCache)(nil).Close))
}
...
func (m *MockIRedisCache) Ping(ctx context.Context) *redis.StatusCmd {
	m.ctrl.T.Helper()
...
func (mr *MockIRedisCacheMockRecorder) Ping(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Ping", reflect.TypeOf((*MockIRedisCache)(nil).Ping), ctx)
}
