...
// Source: domain/contract/service.go
...
func (m *MockAuthService) CreateSession(ctx context.Context, session entity.Session) error {
	m.ctrl.T.Helper()
...
func (m *MockAuthService) GetSessionByUUID(ctx context.Context, sessionUUID string) (entity.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransferService) GetTransfers(ctx context.Context) ([]entity.Transfer, error) {
	m.ctrl.T.Helper()
