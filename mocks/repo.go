...
// Source: domain/contract/repo.go
...
func (m *MockAuthRepo) GetSessionByUUID(ctx context.Context, sessionUUID string) (entity.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountRepo) GetTransfersByAccountID(ctx context.Context, accountID int64, origin bool) ([]entity.Transfer, error) {
	m.ctrl.T.Helper()
